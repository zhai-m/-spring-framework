...
import cn.zhaim.springframework.context.ConfigurableApplicationContext;
import cn.zhaim.springframework.context.event.ApplicationEventMulticaster;
import cn.zhaim.springframework.context.event.ContextClosedEvent;
import cn.zhaim.springframework.context.event.ContextRefreshedEvent;
import cn.zhaim.springframework.context.event.SimpleApplicationEventMulticaster;
...
public abstract class AbstractApplicationContext extends DefaultResourceLoader implements ConfigurableApplicationContext {
    ...
    public void refresh() throws BeansException {
        ...
        // 3. 添加 ApplicationContextAwareProcessor，让继承 自 ApplicationContextAware 的 Bean 对象都能感知所属的 ApplicationContext
